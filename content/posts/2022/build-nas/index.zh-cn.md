...
不用树莓派的原因是，它是 ARM 架构的微型“电脑”，Arch Linux 官方只支持 x86_64 架构的系统，Arch Linux ARM 准却来说实际上是个第三方的系统。
...
目前组装的 NAS 还只是个半成品，才刚开始 24 小时不断电运行，因为没插硬盘所以晚上睡觉时只能听到非常细微的风扇转动的声音（移动硬盘设置了自动停转所以晚上没声音），后续如果有什么更新我再写到这里，时间有限先写这么多。
